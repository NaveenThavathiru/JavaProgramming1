...
/**
 * With user input, find out the winner between two bids and displays the winner with the total cost. 
 *
               ...
               System.out.printf("\n The winner is %s! The total cost is $ %.2f ", character1, firstcost);
                       ...
                       if (secondcost < firstcost)
                       {
                           System.out.printf("\n The winner is %s! The total cost is $ %.2f ", character2, secondcost);
                              ...
                              if(firstcost == secondcost && hours < hours2)
                              {
                                 ...
                                 if(firstcost == secondcost && hours2 < hours)
                                 {
